...
<html lang="en" class="layout-navbar-fixed layout-wide" dir="ltr" data-skin="default" data-template="front-pages" data-assets-path="assets/" data-bs-theme="light">
                ...
                <ul class="navbar-nav flex-row align-items-center ms-auto">
                    ...
                    <li class="nav-item dropdown-style-switcher dropdown me-2 me-xl-1">
                        <a class="nav-link dropdown-toggle hide-arrow" id="nav-theme" href="javascript:void(0);"
                            ...
                            <i class="icon-base la la-sun icon-lg theme-icon-active"></i>
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="nav-theme-text">
                            <li>
                                <button type="button" class="dropdown-item align-items-center active"
                                    ...
                                    <span><i class="icon-base la la-sun icon-md me-3"
                            ...
                            <li>
                                <button type="button" class="dropdown-item align-items-center"
                                    ...
                                    <span><i class="icon-base la la-moon icon-md me-3"
