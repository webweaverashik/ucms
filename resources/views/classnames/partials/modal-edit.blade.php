                ...
                <form id="kt_modal_edit_class_form" class="form" action="#" novalidate="novalidate">
                    <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_edit_class_scroll"
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <input type="text" name="class_name_edit" class="form-control form-control-solid"
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <textarea name="description_edit" class="form-control form-control-solid"
                    ...
                    <div class="text-center pt-10">
                        <button type="reset" class="btn btn-light me-3" data-kt-edit-class-modal-action="cancel">
                            Discard
                        </button>
