            ...
            <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-semibold mb-8">
                ...
                <li class="nav-item">
                    <a class="nav-link text-active-primary pb-4" data-bs-toggle="tab" href="#kt_enrolled_students_tab"><i
                            class="ki-outline ki-book fs-3 me-2"></i>Regular Students</a>
                </li>
                <!--end:::Tab item-->
                <!--begin:::Tab item-->
                <li class="nav-item">
                    <a class="nav-link text-active-primary pb-4" data-bs-toggle="tab"
                        href="#kt_secondary_classnames_tab"><i class="ki-outline ki-book fs-3 me-2"></i>Special Class</a>
                </li>
                <!--end:::Tab item-->
                <!--begin:::Tab item-->
                            ...
                            <div class="menu-item px-5 my-1">
                                <a href="#" class="menu-link px-5 text-hover-primary" data-bs-toggle="modal"
                                    data-bs-target="#kt_modal_add_special_class"><i
                                        class="ki-outline ki-book-open fs-2 me-2"></i>Add Special Class
                                </a>
                            </div>
                            <!--end::Menu item-->
                        @endif
