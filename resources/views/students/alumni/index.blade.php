@push('page-css')
    ...
    <link href="{{ asset('css/students/alumni.css') }}" rel="stylesheet" type="text/css" />
@endpush
    ...
    <div class="card">
        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-title">
                ...
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <input type="text" data-kt-alumni-table-filter="search"
                        class="form-control form-control-solid w-350px ps-12" placeholder="Search in Alumni Students">
                </div>
                <!--end::Search-->
            </div>
            <!--begin::Card title-->
            ...
            <div class="card-toolbar">
                ...
                <div class="d-flex justify-content-end" data-kt-subscription-table-toolbar="base">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown w-350px w-md-500px" data-kt-menu="true">
                        ...
                        <!--end::Separator-->
                        <!--begin::Content-->
                        <div class="px-7 py-5" data-kt-alumni-table-filter="form">
                            <div class="row">
                            ...
                            <div class="d-flex justify-content-end">
                                <button type="reset"
                                    ...
                                    data-kt-menu-dismiss="true" data-kt-alumni-table-filter="reset">Reset</button>
                                <button type="submit" class="btn btn-primary fw-semibold px-6"
                                    data-kt-menu-dismiss="true" data-kt-alumni-table-filter="filter">Apply</button>
                            </div>
                            <!--end::Actions-->
                        </div>
                        <!--end::Content-->
                    ...
                    <div class="dropdown">
                        ...
                        <!--begin::Menu-->
                        <div id="kt_alumni_export_dropdown_menu"
                            class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4"
                            data-kt-menu="true">
                            <!--begin::Menu item-->
                            <div class="menu-item px-3">
                                <a href="#" class="menu-link px-3" data-alumni-export="copy">Copy to clipboard</a>
                            </div>
                            <div class="menu-item px-3">
                                <a href="#" class="menu-link px-3" data-alumni-export="excel">Export as Excel</a>
                            </div>
                            <div class="menu-item px-3">
                                <a href="#" class="menu-link px-3" data-alumni-export="csv">Export as CSV</a>
                            </div>
                            <div class="menu-item px-3">
                                <a href="#" class="menu-link px-3" data-alumni-export="pdf">Export as PDF</a>
                            </div>
                            <!--end::Menu item-->
                        </div>
                        <!--end::Menu-->
        ...
        <div class="card-body py-4">
            @if ($isAdmin)
                ...
                <ul class="nav nav-tabs nav-line-tabs nav-line-tabs-2x mb-5 fs-6" id="alumniBranchTabs" role="tablist">
                    @foreach ($branches as $index => $branch)
                        ...
                        <li class="nav-item" role="presentation">
                            <a class="nav-link fw-bold {{ $index === 0 ? 'active' : '' }}"
                                id="tab-alumni-branch-{{ $branch->id }}" data-bs-toggle="tab"
                                href="#kt_tab_alumni_branch_{{ $branch->id }}" role="tab"
                                aria-controls="kt_tab_alumni_branch_{{ $branch->id }}"
                                aria-selected="{{ $index === 0 ? 'true' : 'false' }}"
                                data-branch-id="{{ $branch->id }}">
                                <i class="ki-outline ki-bank fs-4 me-1"></i>
                                {{ ucfirst($branch->branch_name) }}
                                <span class="badge {{ $tabBadgeColor }} ms-2 alumni-branch-count-badge badge-loading"
                                    data-branch-id="{{ $branch->id }}">
                ...
                <!--begin::Tab Content-->
                <div class="tab-content" id="alumniBranchTabsContent">
                    @foreach ($branches as $index => $branch)
                        <div class="tab-pane fade {{ $index === 0 ? 'show active' : '' }}"
                            id="kt_tab_alumni_branch_{{ $branch->id }}" role="tabpanel"
                            aria-labelledby="tab-alumni-branch-{{ $branch->id }}">
                            @include('students.alumni.partials.alumni-table', [
                                'tableId' => 'kt_alumni_students_table_branch_' . $branch->id,
                                'branchId' => $branch->id,
                            ])
                        </div>
                    @endforeach
            ...
            @else
                ...
                @include('students.alumni.partials.alumni-table', [
                    'tableId' => 'kt_alumni_students_table',
                    'branchId' => null,
                ])
...
@push('page-js')
    <script>
        ...
        const routeAlumniData = "{{ route('students.alumni.data') }}";
        const routeAlumniBranchCounts = "{{ route('students.alumni.branch-counts') }}";
