...
@section('header-title')
    <div data-kt-swapper="true" data-kt-swapper-mode="{default: 'prepend', lg: 'prepend'}"
        ...
        <!--begin::Title-->
        <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 align-items-center my-0">{{ $student->name }},
            {{ $student->student_unique_id }}</h1>
        <!--end::Title-->
        <!--begin::Separator-->
                                    ...
                                    <div class="overflow-hidden flex-grow-1">
                                        <select name="invoice_student_edit"
                                            ...
                                            <option value="{{ $student->id }}">{{ $student->name }}
                                                ...
                                                {{ ucfirst($student->payments->payment_style) }} -
                                                1/{{ $student->payments->due_date }}</option>
                                        </select>
                                    </div>
                                </div>
