...
@section('content')
    <form action="{{ route('students.store') }}" id="createproduct-form" autocomplete="off" class="needs-validation" novalidate method="POST" enctype="multipart/form-data">
    @csrf
        <div class="row">
            <div class="col-lg-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            <label class="form-label" for="product-title-input">Full Name (In English)</label>
                        ...
                        <div class="mb-3">
                            <label class="form-label" for="product-title-input">পূর্ণ নাম (বাংলায়)</label>
                            <input type="hidden" class="form-control" id="formAction" name="formAction" value="add">
                            <input type="text" class="form-control d-none" id="product-id-input">
                            <input type="text" class="form-control" id="product-title-input" value=""
                        ...
                        <div class="mb-3">
                            <label class="form-label" for="product-title-input">Home Address</label>
                            <input type="hidden" class="form-control" id="formAction" name="formAction" value="add">
                            <input type="text" class="form-control d-none" id="product-id-input">
                            <input type="text" class="form-control" id="product-title-input" value=""
