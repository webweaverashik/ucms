                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <input type="text" name="student_home_address"
                                        ...
                                        placeholder="Write student home address" value="{{ old('student_home_address') }}"
                                        required />
                                    <!--end::Input-->
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <input type="text" name="student_phone_whatsapp" maxlength="11"
                                                ...
                                                value="{{ old('student_phone_whatsapp') }}" />
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input group-->
                                    </div>
                        ...
                        <div class="fv-row">
                            ...
                            <div class="form-group row mb-3 border border-dashed px-2 py-3 rounded">
                                ...
                                <div class="col-md-1">
                                    ...
                                    <input type="number" class="form-control form-control-solid mb-2 mb-md-0" min="6" max="20"
                                        name="sibling_1_age" />
                                </div>
                                <div class="col-md-1">
