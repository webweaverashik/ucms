...
@section('header-title')
    <div data-kt-swapper="true" data-kt-swapper-mode="{default: 'prepend', lg: 'prepend'}"
        ...
        <!--begin::Title-->
        <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 align-items-center my-0">Admission Form</h1>
        <!--end::Title-->
        <!--begin::Separator-->
            ...
            <form class="card-body py-20 w-100 px-9" novalidate="novalidate" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" name="student_name" class="form-control form-control-solid mb-3 mb-lg-0"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="fv-row">
                                            ...
                                            <div class="input-group input-group-solid flex-nowrap">
                                                <span class="input-group-text"><i class="las la-calendar fs-3"></i></span>
                                                <div class="overflow-hidden flex-grow-1">
                                                    <input name="birth_date" id="student_birth_date" placeholder="Select a date"
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <!--end::Image input-->
                                    <!--begin::Hint-->
                                    <div class="form-text">Allowed file types: png, jpg, jpeg. Max 50 kB</div>
                                    <!--end::Hint-->
                                </div>
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <div class="input-group input-group-solid flex-nowrap">
                                        <span class="input-group-text"><i class="las la-star-and-crescent fs-3"></i></span>
                                        <div class="overflow-hidden flex-grow-1">
                                ...
                                <div class="fv-row">
                                    ...
                                    <!--begin::Solid input group style-->
                                    <div class="input-group input-group-solid flex-nowrap">
                                        <span class="input-group-text"><i class="las la-tint fs-3"></i></span>
                                        <div class="overflow-hidden flex-grow-1">
                ...
                <div data-kt-stepper-element="content">
                    ...
                    <div class="w-100">
                        ...
                        <div class="mb-15">
                            <!--begin::Label-->
                            <label class="form-label fs-3">Guardians <span
                                    class="text-muted">(at least one guardian)</span></label>
                            <!--end::Label-->
                ...
                <div data-kt-stepper-element="content">
                    <div class="w-100">
                        <div class="pb-10 pb-lg-12">
                            ...
                            <div class="text-muted fw-semibold fs-6">Assign to class and select enrolled subjects.</div>
                        </div>
                        <div class="row mb-6">
                            <div class="col-lg-7 fv-row">
                                <div class="fv-row mb-7">
                                    <label class="form-label required fs-6 fw-semibold">Class</label>
                                    <select name="student_class" id="student_class_input" class="form-select form-select-solid"
                                            data-control="select2" data-placeholder="Select a class" required>
                                        <option></option>
                                        @foreach($classnames as $classname)
                                            <option value="{{ $classname->id }}"
                                                    data-class-numeral="{{ $classname->class_numeral }}">{{ $classname->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row mb-7">
                            <div class="col-lg-12 fv-row">
                                <label class="form-label fs-6 fw-semibold">
                                    Secondary Classes <span class="text-muted">(Optional)</span>
                                </label>
                                <select name="secondary_classes[]" class="form-select form-select-solid"
                                        data-control="select2" data-close-on-select="false" data-placeholder="Select secondary classes"
                        ...
                        <div class="row mb-7">
                             <div class="col-lg-12 fv-row">
                                <div class="form-check form-check-custom form-check-solid">
                                    <input class="form-check-input" type="checkbox" value="1" id="only_secondary_class" name="only_secondary_class"/>
                                    <label class="form-check-label fs-6 fw-bold text-gray-800" for="only_secondary_class">
                                        Only Secondary Class
                                    </label>
                                    <span class="form-text ms-2 text-muted">
                                        (If checked, Admission Fee and Tuition Fee will be set to 0. Enrolled subjects will be ignored.)
                                    </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <div class="input-group input-group-solid flex-nowrap">
                                <span class="input-group-text"><i class="ki-outline ki-bank fs-3"></i></span>
                                <div class="overflow-hidden flex-grow-1">
                        ...
                        <div class="fv-row">
                            ...
                            <div class="notice d-flex bg-light-primary rounded border-primary border border-dashed p-4 mb-6">
                                ...
                                <div class="fw-semibold">
                                    <div class="fs-6 text-gray-700"><strong>Compulsory subjects</strong> are auto-selected. For
                                        <strong>optional subjects</strong>, select one as main and one as 4th subject.
                                    </div>
                                </div>
                            </div>
                            <div id="subject_list">
                    ...
                    <div class="w-100">
                                    ...
                                    <div class="col">
                                        <label
                                            ...
                                            <span
                                                ...
                                                <input class="form-check-input branch-radio" type="radio" name="student_branch"
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <div id="batch-container" class="row row-cols-1 row-cols-md-3 row-cols-lg-2 row-cols-xl-4 g-9"
                                 data-kt-buttons="true" data-kt-buttons-target="[data-kt-button='true']">
                                @php $defaultBranchId = $branches->first()->id; @endphp
                                @foreach($branches as $branch)
                                    @foreach($batches->where('branch_id', $branch->id) as $batch)
                                        <div class="col batch-option" data-branch="{{ $branch->id }}"
                                            ...
                                            <label
                                                ...
                                                <span class="ms-5">
                                                    <span
                                                        class="fs-4 fw-bold text-gray-800 d-block">{{ $batch->name }} ({{ $batch->branch->branch_prefix }})</span>
                                                </span>
                                            </label>
                                        </div>
                                    @endforeach
                        ...
                        <!-- Secondary Class Fees & Only Secondary Option -->
                        <div id="secondary-class-fees-container" class="row"></div>
                        ...
                        <div class="row">
                                ...
                                <div class="mb-7 fv-row">
                                    ...
                                    <label class="required fw-semibold fs-6 mb-2">Admission Fee
                                        <span class="ms-1" data-bs-toggle="tooltip"
                                            ...
                                            <i class="ki-outline ki-information text-gray-500 fs-4"></i>
                                        </span>
                                    </label>
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="number" class="form-control form-control-solid"
                                           name="student_admission_fee" min="0" placeholder="Admission fee" required/>
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                            </div>
                            <div class="col-md-3">
                                ...
                                <div class="mb-7 fv-row">
                                    <!--begin::Label-->
                                    <label class="required fw-semibold fs-6 mb-2">Tuition Fee <span data-bs-toggle="tooltip"
                                                                                                  data-bs-placement="top"
                                                                                                  title="Set any amount. Set 0 for FREE students."><i
                                                class="ki-outline ki-information text-gray-500 fs-4"></i></span></label>
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="number" class="form-control form-control-solid" name="student_tuition_fee"
                                           min="0" placeholder="Monthly tuition fee" required/>
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                            </div>
                            <div class="col-md-3">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <div class="d-flex mt-3">
                                        ...
                                        <div class="form-check form-check-custom form-check-solid">
                                            <input class="form-check-input" type="radio" value="due" name="payment_style"
                                                   id="payment_style_due" required/>
                                            <label class="form-check-label fs-6 fw-medium"
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <select name="payment_due_date" class="form-select form-select-solid"
                                            ...
                                            data-placeholder="Select due date" required>
                                        <option></option>
                        ...
                        <div class="mb-0">
                            ...
                            <div class="notice d-flex bg-light-warning rounded border-warning border border-dashed p-6">
                                ...
                                <div class="d-flex flex-stack flex-grow-1">
                                    <!--begin::Content-->
                                    <div class="fw-semibold">
                                        <h4 class="text-gray-900 fw-bold"><span id="admitted_name">Ashikur Rahman</span>, ID:
                                            <span id="admitted_id">G-250905</span></h4>
