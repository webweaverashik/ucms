            ...
            <div class="col-xl-6">
                <div class="card shadow-sm h-100">
                    ...
                    <div class="card-body pt-2">
                        ...
                        <ul class="nav nav-tabs nav-line-tabs nav-stretch fs-7 border-0 mb-4">
                            <li class="nav-item">
                                <a class="nav-link active fw-semibold" data-bs-toggle="tab" href="#attByClass">By
                                    Class</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link fw-semibold" data-bs-toggle="tab" href="#attByBatch">By Batch</a>
                            </li>
                        </ul>
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="attByClass">
                            ...
                            <div class="tab-pane fade" id="attByBatch">
                                <div id="attendanceByBatchList" class="table-scrollable" style="max-height: 200px;">
                                    <div class="d-flex justify-content-center py-5">
                                        <span class="spinner-border spinner-border-sm text-primary"></span>
                                    </div>
                                </div>
