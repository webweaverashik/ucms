...
<div class="d-flex flex-column flex-column-fluid">
    ...
    <div class="row g-5 mb-5">
        ...
        <div class="col-xl-3 col-md-6">
            <a href="{{ route('students.pending.index') }}" class="card dashboard-card h-100 shadow-sm text-decoration-none">
                <div class="card-body d-flex align-items-center">
                ...
                <div class="card-header border-0 pt-5">
                    ...
                    <div class="card-toolbar">
                        <div class="d-flex align-items-center">
                            <button type="button" class="btn btn-icon btn-sm btn-light-primary me-2" id="prevDateBtn" title="Previous Day">
                                <i class="bi bi-chevron-left fs-6"></i>
                            </button>
                            <div class="position-relative">
                                <input type="text" class="form-control form-control-sm text-center fw-semibold" id="collectionDatePicker" style="width: 130px;" readonly>
                            </div>
                            <button type="button" class="btn btn-icon btn-sm btn-light-primary ms-2" id="nextDateBtn" title="Next Day">
            ...
            <div class="card shadow-sm h-100">
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        ...
                        <span class="text-muted fw-semibold fs-7" id="userCollectionSubtitle">Today's performance</span>
                    </h3>
                </div>
                <div class="card-body pt-0">
                ...
                <div class="card-header border-0 pt-5">
                    ...
                    <div class="card-toolbar">
                        <ul class="nav nav-pills nav-pills-sm">
                            <li class="nav-item">
                                <a class="nav-link btn btn-sm btn-active-light-primary fw-semibold px-4 active" data-period="month" href="#">Month</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link btn btn-sm btn-active-light-primary fw-semibold px-4" data-period="week" href="#">Week</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link btn btn-sm btn-active-light-primary fw-semibold px-4" data-period="today" href="#">Today</a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="col-xl-6">
            <div class="card shadow-sm h-100">
                <div class="card-header border-0 pt-5">
                    ...
                    <div class="card-toolbar">
                        <div class="d-flex align-items-center">
                            <button type="button" class="btn btn-icon btn-sm btn-light-primary me-2" id="prevAttDateBtn" title="Previous Day">
                                <i class="bi bi-chevron-left fs-6"></i>
                            </button>
                            <div class="position-relative">
                                <input type="text" class="form-control form-control-sm text-center fw-semibold" id="attendanceDatePicker" style="width: 130px;" readonly>
                            </div>
                            <button type="button" class="btn btn-icon btn-sm btn-light-primary ms-2" id="nextAttDateBtn" title="Next Day">
                                <i class="bi bi-chevron-right fs-6"></i>
                            </button>
                        </div>
                    </div>
                ...
                <div class="card-body pt-2">
                    ...
                    <div class="mb-4">
                        <ul class="nav nav-tabs nav-line-tabs nav-stretch fs-7 border-0" id="attendanceBatchTabs">
                            <li class="nav-item">
                                <a class="nav-link active fw-semibold" data-batch-id="" href="javascript:void(0)">All</a>
                            </li>
                        </ul>
                    </div>
                    <div id="attendanceByClassList" class="table-scrollable" style="max-height: 200px;">
