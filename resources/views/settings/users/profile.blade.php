...
<style>
    ...
    @media (max-width: 575.98px) {
        .fs-md-2 { font-size: 1.1rem !important; }
        .fs-md-6 { font-size: 0.85rem !important; }
    }
    ...
    @media (max-width: 767.98px) {
        .card-header.flex-column { align-items: stretch !important; }
        .w-md-auto { width: 100% !important; }
        .w-md-300px { width: 100% !important; }
        .w-md-200px { width: 100% !important; }
    }
    @media (min-width: 768px) {
        .w-md-auto { width: auto !important; }
        .w-md-300px { width: 300px !important; }
        .w-md-200px { width: 200px !important; }
        .card-header.flex-md-row { flex-direction: row !important; }
    }
            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-title">
                    ...
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <input type="text" data-kt-wallet-table-filter="search"
                            class="form-control form-control-solid w-250px ps-13" placeholder="Search wallet logs..." />
                    </div>
                    <!--end::Search-->
                </div>
                <!--end::Card title-->
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end gap-3" data-kt-wallet-table-toolbar="base">
                        ...
                        <!--begin::Menu-->
                        <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true" id="kt_wallet_filter_menu">
                            <!--begin::Header-->
                            <div class="px-7 py-5">
                            ...
                            <div class="px-7 py-5" data-kt-wallet-table-filter="form">
                                ...
                                <div class="mb-5">
                                    ...
                                    <input type="text" class="form-control form-control-solid"
                                        id="wallet_daterangepicker" placeholder="Select date range" readonly />
                                    <input type="hidden" id="wallet_date_range_value" />
                                </div>
                                <!--end::Input group-->
                                <!--begin::Actions-->
            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end gap-3" data-kt-login-table-toolbar="base">
                        ...
                        <!--begin::Menu-->
                        <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true" id="kt_login_filter_menu">
                            <!--begin::Header-->
                            <div class="px-7 py-5">
                                <div class="fs-5 text-gray-900 fw-bold">Filter Options</div>
                            </div>
                            ...
                            <div class="px-7 py-5" data-kt-login-table-filter="form">
                                ...
                                <div class="mb-5">
                                    <label class="form-label fs-6 fw-semibold">Date Range:</label>
                                    <input type="text" class="form-control form-control-solid"
                                        id="login_daterangepicker" placeholder="Select date range" readonly />
                                    <input type="hidden" id="login_date_range_value" />
                                </div>
                                <!--end::Input group-->
                                <!--begin::Actions-->
                                <div class="d-flex justify-content-end">
    ...
    <div class="modal-dialog modal-dialog-centered mw-500px">
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-10 pt-0 pb-15">
                ...
                <form id="kt_modal_password_form" class="form" action="{{ route('users.password.reset', $user->id) }}"
                    method="POST">
                    @csrf
                    @method('PUT')
                                ...
                                <div class="image-input image-input-outline image-input-placeholder"
                                    ...
                                    <label
                                        ...
                                        <input type="file" name="photo" accept=".png, .jpg, .jpeg"
                                            id="photo_input" />
                                        <input type="hidden" name="photo_remove" id="photo_remove" value="0" />
                                    </label>
                                    <span
                                        class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow"
                        ...
                        <div class="fv-row mb-8">
                            ...
                            <div class="image-input image-input-outline image-input-placeholder"
                                ...
                                <label
                                    ...
                                    <input type="hidden" name="photo_remove" id="profile_photo_remove" value="0" />
                                </label>
                                <span
                                    class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow"
