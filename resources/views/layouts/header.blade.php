                    ...
                    <div class="dropdown-menu dropdown-menu-lg" id="search-dropdown">
                        <div data-simplebar style="max-height: 320px;">
                            ...
                            <div class="dropdown-item bg-transparent text-wrap">
                                <a href="{{ route('dashboard') }}" class="btn btn-soft-secondary btn-sm rounded-pill">how to
                                    setup <i class="mdi mdi-magnify ms-1"></i></a>
                                <a href="{{ route('dashboard') }}" class="btn btn-soft-secondary btn-sm rounded-pill">buttons
                    ...
                    <button type="button" class="btn shadow-none" id="page-header-user-dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user"
                                src="{{ asset(auth()->user()->photo_url ?? 'assets/images/users/dummy.png') }}"
                                alt="Header Avatar">
                            <span class="text-start ms-xl-2">
                                <span
                                    class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">{{ auth()->user()->full_name }}</span>
                                <span
                                    class="d-none d-xl-block ms-1 fs-12 user-name-sub-text">{{ auth()->user()->branch->branch_name ?? 'SuperAdmin' }}</span>
                            </span>
                        </span>
                    </button>
