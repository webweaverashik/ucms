...
class ReportController extends Controller
{
    ...
    public function annualDueReportData(Request $request): JsonResponse
    {
        ...
        // - Total Payable = sum of total_amount (what should be collected from all invoices)
        // - Due = sum of amount_due (paid invoices have amount_due = 0, so they contribute 0)
        // - Soft-deleted invoices are automatically excluded (PaymentInvoice uses SoftDeletes)
        // - Soft-deleted students' invoices are excluded via whereNull('deleted_at') in subquery
        ...
        // Process ALL invoices (paid invoices contribute to collectable but have amount_due = 0)
