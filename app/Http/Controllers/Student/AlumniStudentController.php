...
class AlumniStudentController extends Controller
{
    ...
    public function getData(Request $request): JsonResponse
    {
        ...
        foreach ($students as $student) {
            ...
            $actions = $this->buildActionsDropdown($student, $isActive, $isAdmin, $canDeactivate, $canDownloadForm, $canEdit, $canDelete);
