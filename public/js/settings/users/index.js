                        ...
                        fetch(storeUserRoute, {
                            ...
                            .then(async response => {
                                ...
                                if (!response.ok) {
                                    ...
                                    const errors = data.errors ? [...new Set(Object.values(data.errors).flat())].join('<br>') : '';
                                    throw {
...
var KTUsersEditUser = function () {
    ...
    // Photo elements
    const photoInput = document.getElementById('edit_user_photo_input');
    const photoPreview = document.getElementById('edit_user_photo_preview');
    const photoError = document.getElementById('edit_user_photo_error');
    const removePhotoInput = document.getElementById('edit_remove_photo_input');
    const imageInputContainer = document.getElementById('kt_edit_user_image_input');
    ...
    var handlePhotoUpload = function () {
        ...
        photoInput.addEventListener('change', function (e) {
            ...
            imageInputContainer.classList.add('image-input-changed');
    ...
    var handlePhotoRemove = function () {
        var removeBtn = element.querySelector('[data-kt-image-input-action="remove"]');
        if (removeBtn) {
            removeBtn.addEventListener('click', function (e) {
                ...
                photoPreview.style.backgroundImage = 'url(' + defaultPhotoUrl + ')';
                photoError.style.display = 'none';

                imageInputContainer.classList.remove('image-input-changed');
    ...
    var handlePhotoCancel = function () {
        var cancelBtn = element.querySelector('[data-kt-image-input-action="cancel"]');
        if (cancelBtn) {
            ...
            fetch(`/settings/users/${userId}`)
                ...
                .then(data => {
                    if (data.success && data.data) {
                        ...
                        // Set photo
                        originalPhotoUrl = user.photo_url || defaultPhotoUrl;
                        photoPreview.style.backgroundImage = 'url(' + originalPhotoUrl + ')';
            ...
            submitButton.addEventListener('click', function (e) {
                ...
                validator.validate().then(function (status) {
                    if (status === 'Valid') {
                        ...
                        if (selectedFile) {
                            formData.set('user_photo', selectedFile);
                        }
                        ...
                        fetch(`/settings/users/${userId}`, {
                            ...
                            .catch(error => {
                                ...
                                if (error.errors && error.errors.user_photo) {
                                    photoError.textContent = error.errors.user_photo[0];
                                    photoError.style.display = 'block';
                                }
